...
![](https://konsilion.fr/wp/wp-content/uploads/2022/09/Konsilion_Science_Ouverte-5.png){: style="display: flex; margin: auto; max-width: 45%; width:500px; float: right; margin: 15px;"}


# Développons ensemble les technologies de demain.


Konsilion **plateforme R&D**, repose sur le fonctionnement simultané de la production de savoirs (Konnect) et de leur diffusion (Katalog).

* Avec **Konnect**, retrouvez bon nombre d’outils et méthodes nécessaires à la Data Science, en privilégiant les licences Open Sources, libres, Creative Commons, vous avez le choix.

* Avec **Katalog**, diffusez ou retrouvez tout les savoirs dont vous avez besoin. Ainsi accessible en base de données distribuées, les connaissances n’ont plus de limites et ne tiens qu’à nous d’en user.
...
=== "Katalog"
    ...
    **Partage total pour la diffusion des contenus et des savoirs.**
    
    Tous le contenu en base de données distribuées, libre de droit que vous pouvez importer et utiliser pour vous.
...
=== "Konnect"
    ...
    **Pour que la compréhension des outils n’interfère pas avec l’acquisition des méthodes**
    ...
    * **Pas de serveur à gérer** – vos données et projets sont distribués. Cela est possible avec la technologie Git. Cela facilite la diffusion et l’appropriation des savoirs. Git
    ...
    [En savoir plus sur Konnect](../konnect){ .md-button}
